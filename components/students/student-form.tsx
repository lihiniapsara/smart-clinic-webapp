...
const schema = z.object({
  nic: z
    .string()
    .regex(/^\d{9}[vV]$/, "Patient ID must be 9 digits followed by V (e.g. 123456789V)"),
  name: z
    .string()
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          {!student && (
            <p className="text-xs text-slate-400">Photo required for new patient</p>
          )}
        </div>
        ...
        <div className="flex justify-end gap-3 pt-2">
          ...
          <Button type="submit" disabled={loading}>
            ...
            {student ? "Update Patient" : "Create Patient"}
          </Button>
        </div>
      </form>
    </Form>
